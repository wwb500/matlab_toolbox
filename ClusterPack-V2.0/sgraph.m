...
if (lastchar<2),
   fprintf(fid,'%s\n',['./code/ClusterPack-V2.0/pmetis ' dataname ' ' num2str(k)]);
   system(['./code/ClusterPack-V2.0/pmetis ' dataname ' ' num2str(k)])
else
   ubfactor = 5;
   fprintf(fid,'%s\n',['./code/ClusterPack-V2.0/shmetis ' dataname ' ' num2str(k) ' ' num2str(ubfactor)]);
   system(['./code/ClusterPack-V2.0/shmetis ' dataname ' ' num2str(k) ' ' num2str(ubfactor)])
end;
fclose(fid);
